...
def run(config):
    ...
    # make dataset
    dataset = TransformerDataset(pretrained_model=config['tokenizer_model_name'])
    ...
    for epoch in range(config['epochs']):
        ...
        val_loss, bleu = transformer_evaluate(model, val_loader, dataset, criterion, BLEU_mode=config['BLEU_mode'])
